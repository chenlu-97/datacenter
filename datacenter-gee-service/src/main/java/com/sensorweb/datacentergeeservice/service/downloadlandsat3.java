...
//                    String statue1 = "success";
                    String statue2 = landsatService.downloadLandsat(format.format(start.getTime()),"https://earthexplorer.usgs.gov/download/5e83d14fec7cae84/");
                ...
                if(L1TP.size()>0){
                    ...
                    log.info("------ 开始下载" + format.format(start.getTime()) + "的影像-----");
//                    String statue1 = "success";
                    String statue1 = landsatService.downloadLandsat(format.format(start.getTime()),"https://earthexplorer.usgs.gov/download/5e81f14f92acf9ef/");

...
//        log.info("do get request and url[{}]", sb.toString());
     ...
     * @return
     */
    public Response postResponse(String url, Map<String, String> params, String[] headers) {
        Request.Builder builder = new Request.Builder();
        ...
        Response response = null;
        try {
            response = okHttpClient.newBuilder().followRedirects(false)

...
@Slf4j
public class downloadmodis9 implements Runnable{

    @Override
    public void run() {
        System.out.println("-----20200101---------20220315--------MOD09A1----");
        ...
        try {
            String startTime = "2022-06-07 00:00:00";
            String endTime = "2022-10-28 00:00:00";

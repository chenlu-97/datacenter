...
@Slf4j
public class downloadMOD09GA1 implements Runnable{

    @Override
    public void run() {
        System.out.println("-----2000-02-23---------2002-01-01--------MOD09GA----");
        ...
        try {
            String startTime = "2000-02-23 00:00:00";
...
//            String bbox = "73,18,136,54"; //全国
            ...
            while(startloop.before(endloop))
            {
                ...
                for (String product : products) {
                    ...
                    String flag = null;
                    try {
                        flag = insertLAADSService.insertData4( start,end,bbox, product, LAADSConstant.LAADS_DOWNLOAD_TOKEN);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }

...
@Slf4j
public class downloadmodis11 implements Runnable{

    @Override
    public void run() {
        System.out.println("-----20200101---------20221121--------MOD09GA----");
        ...
        try {
            String startTime = "2021-08-25 00:00:00";
            String endTime = "2022-01-01 00:00:00";
            String product = "MOD09GA";
...
//            String bbox = "73,18,136,54"; //全国
            ...
            while(startloop.before(endloop))
            {
                ...
                Thread.sleep(30 * 1000); //下载太快会断开连接，这里休息10s

...
@Slf4j
public class downloadMOD09GA9 implements Runnable{

    @Override
    public void run() {
        System.out.println("-----2016-01-01---------2018-01-01 --------MOD09GA----");
...
//            String bbox = "73,18,136,54"; //全国
            ...
            while(startloop.before(endloop))
            {
                ...
                for (String product : products) {
                    ...
                    String flag = null;
                    try {
                        flag = insertLAADSService.insertData4( start,end,bbox, product, LAADSConstant.LAADS_DOWNLOAD_TOKEN5);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }

...
@Slf4j
public class downloadMOD09GA4 implements Runnable{

    @Override
    public void run() {
        System.out.println("-----2006-01-01---------2008-01-01--------MOD09GA----");
        ...
        try {
            String startTime = "2006-01-01 00:00:00";
            String endTime = "2008-01-01 00:00:00";
...
//            String bbox = "73,18,136,54"; //全国
            ...
            while(startloop.before(endloop))
            {
                ...
                for (String product : products) {
                    ...
                    String flag = null;
                    try {
                        flag = insertLAADSService.insertData4( start,end,bbox, product, LAADSConstant.LAADS_DOWNLOAD_TOKEN2);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
